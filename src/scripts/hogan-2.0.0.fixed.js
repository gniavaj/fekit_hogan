    ...
    function walk(tree) {
        ...
        for (var i = 0, l = tree.length; i < l; i++) {
            ...
            if (tag == '#') {
                ...
                code.push(partial(tree[i]));
            } else if (tag == '{' || tag == '&') {
                code.push(tripleStache(tree[i].n, chooseMethod(tree[i].n)));
            } else if (tag == '\n') {
                code.push(text('"\\n"' + (tree.length-1 == i ? '' : ' + i')));
            } else if (tag == '_v') {
                code.push(variable(tree[i].n, chooseMethod(tree[i].n)));
            } else if (tag === undefined) {
                code.push(text('"' + esc(tree[i]) + '"'));
            }
        }
        return code.join('');
    }
